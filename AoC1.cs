...
namespace AoC_Puzzle1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Looking for the first duplicate..");
            while(duplicate == 1010101)
            {
                if (count == 1)
                    firstRunThrough = answer;
                duplicateSearch();
            }

            Console.WriteLine("Answer after one run through: " + firstRunThrough);
            Console.WriteLine("Duplicate: " + duplicate);
            Console.WriteLine("This many runs to find a duplicate: " + count);
        }
    }
}
